...
INSERT INTO scm.orders VALUES (1000000008, TO_DATE('2026-02-28', 'YYYY-MM-DD'), 4, TO_DATE('2026-03-04', 'YYYY-MM-DD'), TO_DATE('2026-03-08', 'YYYY-MM-DD'), SYSTIMESTAMP, SYSTIMESTAMP, 'admin', 'admin', 445.80, '6777');
...
INSERT INTO scm.order_line VALUES (1000000008, TO_DATE('2026-02-28', 'YYYY-MM-DD'), SYSTIMESTAMP, SYSTIMESTAMP, 'admin', 'admin', 213456, 'Graphics Tablet', 199.99, 2, 4);
INSERT INTO scm.order_line VALUES (1000000008, TO_DATE('2026-02-28', 'YYYY-MM-DD'), SYSTIMESTAMP, SYSTIMESTAMP, 'admin', 'admin', 2345678901, 'Stylus Pen', 22.99, 2, 4);
